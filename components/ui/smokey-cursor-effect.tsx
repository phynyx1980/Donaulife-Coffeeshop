...
interface FluidCursorEffectProps {
  /** "demo" zeigt die volle Demo-Seite, "overlay" nur den transparenten Canvas-Layer für den Seiten-Hintergrund */
  variant?: "demo" | "overlay";
}

const FluidCursorEffect = ({ variant = "demo" }: FluidCursorEffectProps) => {
  ...
  useEffect(() => {
    ...
    let displayMaterial: GLMaterial;
    ...
    const initializeShaders = () => {
      ...
      advectionProgram = new GLProgram(baseVertexShader, advectionShader);
      ...
      displayMaterial = new GLMaterial(baseVertexShader, displayShaderSource);
    };
    ...
    const initFramebuffers = () => {
      ...
      const rgba = ext.formatRGBA as TextureFormat;
      const rg = ext.formatRG as TextureFormat;
      const r = ext.formatR as TextureFormat;
      ...
      <div className="relative z-10 p-6 sm:p-12 lg:p-20 text-white font-sans pointer-events-auto w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg lg:text-xl leading-relaxed mb-8 lg:mb-12 text-gray-300 max-w-3xl mx-auto">
            Move your mouse around to create beautiful fluid smoke effects. The simulation uses
            WebGL shaders to create realistic fluid dynamics in real-time.
          </p>
